# Default Dark Theme for Inkdrop

> [!NOTE]
> Do not fork this repository to create your own theme. Please read the documentation linked below.

The default dark theme for Inkdrop. A single unified theme that styles the app UI, the editor syntax, and the Markdown preview.
